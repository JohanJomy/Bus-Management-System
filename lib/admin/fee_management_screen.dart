        ...
        children: [
          ...
          LayoutBuilder(
            builder: (context, constraints) {
              ...
              final left = SizedBox(
                width:
                    isStacked ? double.infinity : constraints.maxWidth * 0.32,
                child: const _FeeConfigurationCard(),
              );

              final right = SizedBox(
                width:
                    isStacked ? double.infinity : constraints.maxWidth * 0.64,
      ...
      child: Column(
        ...
        children: [
          ...
          Padding(
            ...
            child: Column(
              children: [
                _buildStopFeeItem('Downtown Central', 'Monthly transport fee', '\$120'),
                const SizedBox(height: 16),
                _buildStopFeeItem('North Suburb', 'Monthly transport fee', '\$100'),
                const SizedBox(height: 16),
                _buildStopFeeItem('East Gate Terminus', 'Monthly transport fee', '\$150'),
                const SizedBox(height: 16),
                _buildStopFeeItem('West River Plaza', 'Monthly transport fee', '\$130'),
        ...
        children: [
          ...
          LayoutBuilder(
            builder: (context, constraints) {
              ...
              rows: [
                _paymentRow('RS', const Color(0xFFE5EDFF), const Color(0xFF1D4ED8), 'Rahul Sharma', 'BTech (CS)', '\$120', 'Oct 12, 2023', 'Paid', const Color(0xFF15803D), const Color(0xFFD1FAE5)),
                _paymentRow('AP', const Color(0xFFFFEDD5), const Color(0xFFEA580C), 'Ananya Patel', 'MCA', '\$100', 'Oct 14, 2023', 'Pending', const Color(0xFFC2410C), const Color(0xFFFFEDD5)),
                _paymentRow('VJ', const Color(0xFFDBEAFE), const Color(0xFF1D4ED8), 'Vikram Jha', 'BTech (ME)', '\$120', 'Oct 15, 2023', 'Paid', const Color(0xFF15803D), const Color(0xFFD1FAE5)),
                _paymentRow('SM', const Color(0xFFEDE9FE), const Color(0xFF6D28D9), 'Sanya Malhotra', 'MTech', '\$150', 'Oct 18, 2023', 'Pending', const Color(0xFFC2410C), const Color(0xFFFFEDD5)),
                _paymentRow('DS', const Color(0xFFCCFBF1), const Color(0xFF0F766E), 'Deepak Singh', 'BTech (CS)', '\$120', 'Oct 20, 2023', 'Paid', const Color(0xFF15803D), const Color(0xFFD1FAE5)),
              ],
                  ),
                ),
              );
