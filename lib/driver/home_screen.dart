...
class _DriverHomeScreenState extends State<DriverHomeScreen> {
              ...
              child: SingleChildScrollView(
                ...
                child: Column(
                  children: [
                    ...
                    Text('Broadcasting live to 48 students',
                    ...
                    SizedBox(
                      ...
                      child: ElevatedButton(
                        ...
                        style: ElevatedButton.styleFrom(
                          backgroundColor:
                              isTripActive ? Colors.red : primaryColor,
                    ...
                    Row(
                      children: [
                        Expanded(
                            child: _buildStatCard(isDark, cardColor, Icons.group,
                                'TOTAL STUDENTS', '48', textSec, textPrim)),
  ...
  Widget _buildMapCard(
      bool isDark, Color primary, Color textPrim, Color textSec) {
    return Container(
  ...
  Widget _buildMapBtn(
      IconData icon, Color color, bool isDark, VoidCallback onPressed) {
