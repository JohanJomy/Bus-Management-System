            ...
            Padding(
              ...
              child: Row(
                ...
                children: [
                  ...
                  Text('Tracking Restricted', style: TextStyle(fontWeight: FontWeight.w600, color: isDark ? Colors.white : Colors.black)),
            ...
            Padding(
              ...
              child: Column(
                children: [
                  ...
                  TextButton(
                    onPressed: () {},
                    child: Text('View Details', style: TextStyle(color: isDark ? Colors.grey[400] : Colors.grey[500], fontWeight: FontWeight.w600)),
                  ),
                ],
              ),
            ),
