        ...
        child: Center(
          child: SingleChildScrollView(
            child: Container(
              ...
              // Shadow mimics shadow-2xl but applied to scaffold usually implies body bg. 
              // HTML had a container with max-w-[430], so we constrain the column.
              child: Column(
                  ...
                  Row(
                    children: [
                      ...
                      Padding(
                        ...
                        child: Text("OR", style: TextStyle(color: iconColor, fontSize: 12, fontWeight: FontWeight.bold, letterSpacing: 1.2)),
                      ),
                      Expanded(child: Container(height: 1, color: borderColor)),
                    ],
                  ),
                  ...
                  Container(
                    ...
                    child: TextButton(
                      ...
                      child: Row(
                        mainAxisAlignment: MainAxisAlignment.center,
                        children: [
                          // Simple Google Icon logic (using Icons for now to avoid asset dependency)
                          // In a real app with assets, use Image.asset('assets/google.png')
